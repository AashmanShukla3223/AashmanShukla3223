...
export default function LoadingScreen({ onFinish }: { onFinish: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="fixed top-0 left-0 h-[4px] transition-all duration-150 ease-out"
        style={{
          width: `${topPct * 100}%`,
      ...
      <div
        className="fixed top-0 right-0 w-[4px] transition-all duration-150 ease-out"
        style={{
          height: `${rightPct * 100}%`,
      ...
      <div
        className="fixed bottom-0 right-0 h-[4px] transition-all duration-150 ease-out"
        style={{
          width: `${bottomPct * 100}%`,
      ...
      <div
        className="fixed bottom-0 left-0 w-[4px] transition-all duration-150 ease-out"
        style={{
          height: `${leftPct * 100}%`,
