...
export default function Writing() {
  ...
  return <div className="max-w-4xl mx-auto">
    <header className="max-w-2xl animate-slide-up"><h1 className="mt-4 text-5xl sm:text-7xl font-bold tracking-[-0.06em] text-white">Things I<br /><span className="text-white/35">keep noticing.</span></h1><p className="mt-6 text-lg text-white/60 leading-relaxed">Small essays about old interfaces, new tools, and the feeling between the two.</p></header>
